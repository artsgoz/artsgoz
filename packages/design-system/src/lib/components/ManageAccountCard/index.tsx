      ...
      {children || (
        <div className="flex flex-col h-full items-center">
          ...
          <div className="bg-white rounded-[16px] border border-[#E5E7EB] p-6 w-full flex justify-between items-center shadow-[0px_4px_10px_rgba(0,0,0,0.02)] select-none">
            ...
            <button
              onClick={onEditClick}
              className="w-[48px] h-[48px] rounded-full bg-[var(--color-background-primary-default,#E992B4)] hover:bg-[var(--color-background-primary-dark,#DE5D8F)] text-white flex items-center justify-center cursor-pointer shadow-md hover:scale-105 active:scale-95 transition-all shrink-0"
